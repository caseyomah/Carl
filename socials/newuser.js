module.exports={
	newuser:{
		...
		execute(msg) {
			newconn.send(`Done? Great! Sorry to put you through that mess, but it was pretty important. Now, I'll slip a note to our ${CastingRef} department. They should be by soon to answer any questions and let you in./n/nOnce you are in the main server, you will not have access to this channel.  This is to minimize potential ne'er-do-well influences.`);
